/*
This example connects to an open unauthenticated API on the internet to retrieve some 
data in JSON format and parses it in to a JSON object
...
void loop() {
  ...
  if (httpCode == 200) {
    ...
    const char* data_shortname = data["shortname"];
    Serial.print("Region short name: ");
    Serial.println(data_shortname);
